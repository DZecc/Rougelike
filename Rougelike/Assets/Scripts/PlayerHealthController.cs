...
public class PlayerHealthController : MonoBehaviour
{
    ...
    void Update()
    {
        if(invincCount > 0)
        {
            ...
            if(invincCount <= 0 )
            {
                PlayerController.instance.bodySR.color = new Color(PlayerController.instance.bodySR.color.r, PlayerController.instance.bodySR.color.g, PlayerController.instance.bodySR.color.g, 1f);
            }
        }
    }
